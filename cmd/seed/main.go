...
func seedPermissions(ctx context.Context, client *ent.Client) {
	...
	perms := []permDef{
		{"notifications.notifications.view", "notifications", "View delivery logs and notification history"},
		{"notifications.notifications.add", "notifications", "Send/enqueue notifications"},
		{"notifications.notifications.manage", "notifications", "Full notification management"},
		{"notifications.templates.view", "templates", "View notification templates"},
		{"notifications.templates.manage", "templates", "Create, update, delete templates"},
		{"notifications.templates.manage", "templates", "Send test notifications from templates"},
		{"notifications.providers.view", "providers", "View provider configurations"},
		{"notifications.providers.manage", "providers", "Configure notification providers"},
		{"notifications.config.view", "config", "View tenant settings"},
		{"notifications.config.manage", "config", "Update tenant settings"},
		{"notifications.billing.view", "billing", "View balance and transaction history"},
		{"notifications.billing.manage", "billing", "Initiate top-ups and manage billing"},
		{"notifications.analytics.view", "analytics", "View delivery analytics"},
		{"notifications.analytics.manage", "analytics", "Export analytics data"},
		{"notifications.credits.view", "credits", "View credit balance"},
		{"notifications.credits.manage", "credits", "Manage credit transactions"},
		{"notifications.users.view", "users", "View users in tenant"},
