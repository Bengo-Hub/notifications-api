...
func (_c *RoleCreate) SetNillableScope(v *string) *RoleCreate {
	if v != nil {
		_c.SetScope(*v)
	}
	return _c
...
func (_c *RoleCreate) SetSystemRole(v bool) *RoleCreate {
	_c.mutation.SetSystemRole(v)
	return _c
}

// SetNillableSystemRole sets the "system_role" field if the given value is not nil.
func (_c *RoleCreate) SetNillableSystemRole(v *bool) *RoleCreate {
	if v != nil {
		_c.SetSystemRole(*v)
	}
	return _c
...
func (_c *RoleCreate) check() error {
	...
	if _, ok := _c.mutation.SystemRole(); !ok {
		return &ValidationError{Name: "system_role", err: errors.New(`ent: missing required field "Role.system_role"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.SystemRole(); ok {
		_spec.SetField(role.FieldSystemRole, field.TypeBool, value)
...
// SetScope sets the "scope" field.
func (u *RoleUpsert) SetScope(v string) *RoleUpsert {
	u.Set(role.FieldScope, v)
	return u
}

// UpdateScope sets the "scope" field to the value that was provided on create.
func (u *RoleUpsert) UpdateScope() *RoleUpsert {
	u.SetExcluded(role.FieldScope)
	return u
}

// SetSystemRole sets the "system_role" field.
func (u *RoleUpsert) SetSystemRole(v bool) *RoleUpsert {
	u.Set(role.FieldSystemRole, v)
	return u
}

// UpdateSystemRole sets the "system_role" field to the value that was provided on create.
func (u *RoleUpsert) UpdateSystemRole() *RoleUpsert {
	u.SetExcluded(role.FieldSystemRole)
	return u
}
...
// SetScope sets the "scope" field.
func (u *RoleUpsertOne) SetScope(v string) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.SetScope(v)
	})
}
...
// UpdateScope sets the "scope" field to the value that was provided on create.
func (u *RoleUpsertOne) UpdateScope() *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateScope()
	})
}
...
// SetSystemRole sets the "system_role" field.
func (u *RoleUpsertOne) SetSystemRole(v bool) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.SetSystemRole(v)
	})
}
...
// UpdateSystemRole sets the "system_role" field to the value that was provided on create.
func (u *RoleUpsertOne) UpdateSystemRole() *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateSystemRole()
	})
}
...
// SetScope sets the "scope" field.
func (u *RoleUpsertBulk) SetScope(v string) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.SetScope(v)
	})
}
...
// UpdateScope sets the "scope" field to the value that was provided on create.
func (u *RoleUpsertBulk) UpdateScope() *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateScope()
	})
}
...
// SetSystemRole sets the "system_role" field.
func (u *RoleUpsertBulk) SetSystemRole(v bool) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.SetSystemRole(v)
	})
}
...
// UpdateSystemRole sets the "system_role" field to the value that was provided on create.
func (u *RoleUpsertBulk) UpdateSystemRole() *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateSystemRole()
	})
}
