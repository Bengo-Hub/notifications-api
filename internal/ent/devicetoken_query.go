...
func (_q *DeviceTokenQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *DeviceTokenQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *DeviceTokenQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *DeviceTokenQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *DeviceTokenQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *DeviceTokenQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(devicetoken.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.DeviceToken.Query().
//		Select(devicetoken.FieldTenantID).
//		Scan(ctx, &v)
...
func (_q *DeviceTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(devicetoken.Table, devicetoken.Columns, sqlgraph.NewFieldSpec(devicetoken.FieldID, field.TypeUUID))
	_spec.From = _q.sql
...
func (_q *DeviceTokenQuery) Modify(modifiers ...func(s *sql.Selector)) *DeviceTokenSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *DeviceTokenSelect) Modify(modifiers ...func(s *sql.Selector)) *DeviceTokenSelect {
